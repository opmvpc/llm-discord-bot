...
`,
  user: `
Generate a persona of a weird person with many disorders and troubles. Add a lot of details to make it realistic. Make them sexy, attractive and charismatic. Be creative and have fun! Randomize the details as much as possible, even if you don't know the previous generated personas.
`,
};
